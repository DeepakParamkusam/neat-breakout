...
#Network
with open('trained_models/pac_05_prw_02.pkl', 'rb') as input:
    winner1=pickle.load(input)
winner_net=nn.create_feed_forward_phenotype(winner1);
# print(winner1)
...
class Bricka:
    ...
    def check_input(self):
        ...
        value = winner_net.serial_activate([self.ball.centerx,self.paddle.centerx,self.ball_vel[0],self.ball_vel[1]])
        ...
        if keys[pygame.K_SPACE] and self.state == STATE_BALL_IN_PADDLE:        
            # vx = randint(5,9)  ##Use to set random ball_vel
            # vy = randint(1,9)            
            self.ball_vel = [5,-5]
...
##        if keys[pygame.K_LEFT]:   ### Manual Control
##            self.ball.left -= 5
